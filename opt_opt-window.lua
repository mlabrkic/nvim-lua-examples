...
:luafile "path to"\opt_opt-window.lua

Example:
:so C:\Users\<user name>\Documents\opt_opt-window.lua

------------------------------
I want this:
optionsOption-window_out.txt :
...
A.nvim_buf_set_name(buf, 'optionsOption-window_out.txt')  -- Assign a name to the new buffer
