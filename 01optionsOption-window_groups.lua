...
:luafile "path to"\01options_option-window_groups.lua

Example:
:so C:\Users\<user name>\Documents\01options_option-window_groups.lua
...
local bufnr = A.nvim_create_buf('listed', '')  -- Create a new buffer

A.nvim_buf_set_name(bufnr, '01optionsGroups.txt')  -- Assign a name to the new buffer
