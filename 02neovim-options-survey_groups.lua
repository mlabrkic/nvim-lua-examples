...
------------------------------------------------------------
No 0)
00neovim-options-survey.lua (-->  00optionsDefault.txt)
01options_option-window_groups.lua (-->  01optionsGroups.txt)
...
:luafile "path to"\02neovim-options-survey_groups.lua

Example:
:so C:\Users\<user name>\Documents\02neovim-options-survey_groups.lua
